...
class Settings:
    ...
    openai_job_extraction_model: str = os.getenv("OPENAI_JOB_EXTRACTION_MODEL", "gpt-4o-mini")
    openai_triage_model: str = os.getenv("OPENAI_TRIAGE_MODEL", "gpt-4o-mini")
    openai_comparison_model: str = os.getenv("OPENAI_COMPARISON_MODEL", "gpt-4o-mini")

    openai_reasoning_model: str = os.getenv("OPENAI_REASONING_MODEL", "gpt-4o-mini")
    ...
    def telegram_enabled(self) -> bool:
        return bool(self.telegram_api_key)
